...
<div class="container d-flex justify-content-center align-items-center flex-column" style="height: 100vh">
    <h1 style="margin-bottom: 50px">Vysnena zvirata</h1>
    ...
    <ul class="list-group">
        ...
        $sql = "SELECT nazev FROM zvire WHERE wanted = TRUE";
        ...
        if ($result->num_rows > 0) {
            ...
            echo "Nebyla nalezena žádná vysnena zvířata.";
        }
        ...
        <div class="container d-flex justify-content-center" style="margin-top: 50px">
            <a href="owned-list.php"><button class="btn btn-success">Owned list</button></a>
        </div>
</div>
